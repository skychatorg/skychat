...
export class IFrameFetcher implements VideoFetcher {
    static ALLOWED_SOURCES: string[] = ['https://w.soundcloud.com', 'https://airmash.online', 'https://scdn.nrjaudio.fm', 'https://bruh.io', 'https://stream-49.zeno.fm', 'https://digdig.io'];
