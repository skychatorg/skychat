...
<template>
    <SkyContextMenu :disabled="isSelf">
            ...
            >
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <div class="flex items-center gap-2 font-mono text-xs text-white/40">
                        ...
                        <!-- Motto -->
                        <span
                            v-if="entry.user.data.plugins.motto"
                            class="truncate text-white/35 italic"
                ...
                <div class="shrink-0 flex items-center gap-2">
                    ...
                    <span
                        v-show="entry.user.right > 0"
                        :title="`Level ${entry.user.right}`"
                        class="font-mono text-xs text-primary tabular-nums"
                    >
                        {{ entry.user.right }}
                    </span>
        ...
        <SkyContextMenuItem v-else @select="unblacklistUser">
            <fa icon="ban" class="w-4 mr-2" />
            Unblacklist
        </SkyContextMenuItem>
        <SkyContextMenuItem v-if="canModerate" @select="kickUser">
            <fa icon="power-off" class="w-4 mr-2 text-warn" />
            Kick
        </SkyContextMenuItem>
