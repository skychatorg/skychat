<script setup>
import SkyContextMenu from '@/components/common/SkyContextMenu.vue';
...
<template>
    ...
    <SkyContextMenu :disabled="compact || isAutomatedMessage || isBlacklisted">
        <template #trigger>
            <div
                ...
                <template v-else>
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div v-if="!compact" class="flex items-baseline gap-2 mb-0.5">
                            ...
                            <span
                                v-if="message.user.right > 0"
                                class="font-mono text-xs text-white/30"
                                :title="`Level ${message.user.right}`"
                            >
                                {{ message.user.right }}
                            </span>
        ...
        <SkyContextMenuItem @select="quoteMessage">
            <fa icon="reply" class="w-4 mr-2" />
            Reply
        </SkyContextMenuItem>
        <SkyContextMenuItem v-if="canEditMessage" @select="editMessage">
            <fa icon="pen-to-square" class="w-4 mr-2" />
            Edit
        </SkyContextMenuItem>
